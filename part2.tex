...
Since the simulation in our experiment is non deterministic it should provide more stable results that %if the local region... ?? vielleicht check ich aber auch den satz nicht :D %
the local region of an individual is evaluated more closely, before the synaptic weights are updated, opposed to the strategy of section \ref{sec:strategie_2}.
